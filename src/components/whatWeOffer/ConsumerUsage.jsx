  ...
  return (
    <div className="bg-[#E6E7E9] py-12 ">
      <div className="pt-24 -mt-24">
        <div
          className="w-full min-h-screen max-w-7xl mx-auto overflow-hidden"
          data-aos="fade-up"
        ...
        >
          ...
          <div className="p-8 md:px-16 md:pt-16 pb-10 bg-white max-w-7xl">
            <h1
              className="text-4xl md:text-6xl md:ml-16 font-extralight tracking-wide text-[#006FB9]"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="1000"
            >
            ...
            <h2
              className="text-3xl md:text-4xl md:ml-16 font-semibold text-[#00c3F3] mt-2"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="1000"
            >
            ...
            <p
              className="mt-6 max-w-3xl text-[#006FB9] md:ml-16 text-base font-semibold leading-relaxed"
              data-aos="fade-up"
              data-aos-duration="1000"
              data-aos-delay="1000"
            >
              Our Usage &amp; Attitude studies offer you a well-rounded view of
              how a product or service is used and perceived by consumers,
              helping businesses improve customer satisfaction, enhance
          ...
          {/* Bottom Section */}
          <div
            className="relative w-full bg-[#006FB9] flex flex-col lg:flex-row "
            data-aos="fade-up"
            data-aos-duration="1000"
            data-aos-delay="1000"
          >
            {/* Left Content */}
            <div className="text-white p-8 md:px-16 py-14 md:ml-16 w-full lg:w-2/3 space-y-3">
              {[
                {
                  title: "WHO",
            ...
            <div className="relative lg:absolute lg:-right-52 lg:top-1/2 lg:-translate-y-1/2 flex justify-center items-center py-6 md:py-12 lg:py-0 ">
              <div
              ...
              >
                ...
                >
                  <h3
                    className="text-3xl md:text-5xl font-semibold text-black mb-4 md:mr-48"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="1000"
                  >
                  ...
                  <p
                    className="text-xl md:text-3xl font-semibold text-black mb-6 md:mr-36"
                    data-aos="fade-up"
                    data-aos-duration="1000"
                    data-aos-delay="1000"
                  >
                  ...
                  <ul className="space-y-4 text-black text-left md:mr-24">
                    <li

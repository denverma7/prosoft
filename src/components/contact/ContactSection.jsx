...
return (
    <section className="bg-[#fdf8e9] md:py-10">
      <div className="max-w-6xl sm:mx-auto grid md:grid-cols-2 mt-15 rounded-xl overflow-hidden px-2 mr-2 sm:px-1">
        ...
        <div className="bg-[#00B0F0] text-white p-8 flex flex-col rounded-t-3xl rounded-b-none md:rounded-l-3xl md:rounded-r-none justify-start gap-8">
          ...
          <p className="text-gray-200 text-sm" data-aos="fade-up" data-aos-delay="700">
            At <span className="font-bold">Prosoft</span>, we help businesses make confident decisions through data-driven market insights. 
            Contact us for research inquiries, collaborations, or consultations.
          </p>

          <div>
            <div className='flex items-start gap-4 font-semibold' data-aos="fade-up" data-aos-delay="700">
              ...
              <div className="flex flex-col mb-10">
                ...
                <p className='text-[14px]'>- No.57, W A Silva mawatha, Colombo 06 <br /> </p>
                <p className='text-[14px] mt-1'>- No.8 A, Vajira road, Bambalapitya, Colombo 04 <br /></p>
                <p className='text-[13px] text-gray-700'>Schedule an appointment</p>
              </div>
            </div>
            <div className='flex items-start gap-4 font-semibold' data-aos="fade-up" data-aos-delay="800">
              <div className="flex items-center justify-center w-12 h-[43px] bg-white rounded-[10px] mb-2 p-2">
              ...
              <div className="flex flex-col mb-10">
                ...
                <p className='text-[13px] text-gray-700'>Monday to Friday, 10:00 AM - 5:00 PM</p>
              </div>
            </div>
            <div className='flex items-start gap-4 font-semibold' data-aos="fade-up" data-aos-delay="900">
              <div className="flex items-center justify-center w-12 h-[43px] bg-white rounded-[10px] mb-2 p-2">
              ...
              <div className="flex flex-col">
                ...
                <p className='text-[13px] text-gray-700'>Send us your questions anytime</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <form
          ...
          >
            <div className="grid grid-cols-1 gap-4 ml-10 mr-10">
              <p className="text-[#00B0F0] font-bold text-2xl md:text-3xl mt-2 mb-4" data-aos="fade-up" data-aos-delay="500">Send us a message</p>

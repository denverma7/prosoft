  ...
  return (
    <div className='relative bg-[#E6E7E9] h-full p-4 md:p-12'>
        ...
        <div className='absolute top-40 left-32 z-10'>
            <img src={ServicesImage} alt="Our Service Advantages" className='max-h-[488px]' />
            ...
            <div className='ml-68 mt-16'>
                ...
                <p className='-mt-8 ml-16 font-bold'>24/7 support service to clients</p>
            ...
            <div className='ml-76 mt-2'>
                ...
                <p className='-mt-12 ml-116 font-bold'>Data processing with inbuilt checks to <br />guaranteed data quality</p>
            </div>
            ...
            <div className='ml-108 mt-2'>
                ...
                <p className='-mt-8 ml-16 font-bold'>Transparency in all activities</p>
            </div>
            ...
            <div className='ml-128 mt-2'>
                ...
                <p className='-mt-10 ml-16 font-bold'>Network of External Consultants <br />and Researchers</p>
            </div>
        </div>
    </div>
  )
